  ...
  <body>
    <center>
      <section>
        ...
        <hr class="makeSpace">
        <div class="charts">
          <div class="box" id="account" onclick="location.href = 'accounts.php'">
            <span class="logo">&#x1F468;&#x200D;&#x1F469;&#x200D;&#x1F467;&#x200D;&#x1F466;</span>
            <label for="account">View Accounts</label>
          </div>
          <div class="box" id="transfer" onclick="location.href = 'transaction.php'">
            <span class="logo">&#x1F4B1;</span>
            <label for="transfer">Make a Transaction</label>
          </div>
          <div class="box" id="history"  onclick="location.href = 'transaction.php'">
            <span class="logo">&#x1F4C3;</span>
